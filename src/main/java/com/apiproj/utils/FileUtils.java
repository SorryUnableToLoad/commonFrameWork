...
public class FileUtils {
    ...
    public static void appendTextToFile(String filePath, String textToWrite) {
        try {
            ...
            throw new RuntimeException("Exception while appending text to file.");
        }
    }
    ...
    public static void deleteDirectory(String dirName) {
        try {
            ...
            System.out.println(" Exception while deleteDirectory ");
        }
    }
    ...
    public static void createDirectory(String fileName) {
        ...
        if (!file.exists()) {
            ...
            try {
                ...
                throw new RuntimeException("Exception while creating directory");
            }
        }
